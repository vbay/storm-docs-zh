...
* How to set in your code (examples):
    * [TopologyBuilder#setSpout()](javadocs/org/apache/storm/topology/TopologyBuilder.md)
    * [TopologyBuilder#setBolt()](javadocs/org/apache/storm/topology/TopologyBuilder.md)
...
* Configuration option: [TOPOLOGY_TASKS](javadocs/org/apache/storm/Config.md#TOPOLOGY_TASKS)
* How to set in your code (examples):
    * [ComponentConfigurationDeclarer#setNumTasks()](javadocs/org/apache/storm/topology/ComponentConfigurationDeclarer.md)
...
* [TOPOLOGY_MAX_TASK_PARALLELISM](javadocs/org/apache/storm/Config.md#TOPOLOGY_MAX_TASK_PARALLELISM): This setting puts a ceiling on the number of executors that can be spawned for a single component. It is typically used during testing to limit the number of threads spawned when running a topology in local mode. You can set this option via e.g. [Config#setMaxTaskParallelism()](javadocs/org/apache/storm/Config.md#setMaxTaskParallelism(int)).
