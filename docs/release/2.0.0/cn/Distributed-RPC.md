...
Storm comes with a topology builder called [LinearDRPCTopologyBuilder](javadocs/org/apache/storm/drpc/LinearDRPCTopologyBuilder.md) that automates almost all the steps involved for doing DRPC. These include:
