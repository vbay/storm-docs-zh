...
Please read [Storm SQL integration](storm-sql.md) page first to see what features Storm SQL supports. 
...
[conformance levels]({{ site.apiRoot }}/org/apache/calcite/sql/validate/SqlConformance.md#isFromRequired--).
...
* `producer`: Specify Kafka Producer configuration - Please refer [Kafka producer configs](http://kafka.apache.org/documentation.md#producerconfigs) for details.
