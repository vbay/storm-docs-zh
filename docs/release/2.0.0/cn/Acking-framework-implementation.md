...
You can read a bit more about the [reliability mechanism](Guaranteeing-message-processing.md#what-is-storms-reliability-api) elsewhere on the wiki -- this explains the internal details.
